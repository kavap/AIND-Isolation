    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        (int, int)
            ...
            (-1, -1) if there are no available legal moves.
        """
        # Iterative deepening should handle timeout and return best move available before timeout and
        # time_left function and TIMER_THRESHOLD should be passed to each function to avoid side effects
        # but due to project submission interface requirements sticking to non parallelizable Object
        # oriented implementation :(

        self.time_left = time_left
        best_move =  self.iterativeDeepening(game)
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        if level_to_evaluate == depth:
            ...
            (move_score,best_move) = self.max_value(game,depth,level_to_evaluate,alpha,beta)
            return best_move
